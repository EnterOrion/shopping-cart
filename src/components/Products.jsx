            ...
            <Navigation />
                <div className="product-listing">
                  <div className="product-and-title">
                            ...
                            <ProductCard image={BeautifulPlaceVinyl} closeup={BeautifulPlace} id="5" title="In a Beautiful Place Vinyl" alt="A Beautiful Place Out in the Country Vinyl" altCloseup="A Beautiful Place Out in the Country album cover" price="$19.99" />
                  </div>
                    </div>
                </div>
